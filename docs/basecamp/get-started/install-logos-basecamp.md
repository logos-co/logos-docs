...
Logos [Basecamp](/get-started/glossary#basecamp) is the desktop shell for Logos. You can discover, install, and run Logos modules and apps using its graphical interface as an alternative to the command line.
