...
1. Build `logoscore` and `lgpm`:
   ...
   ```bash
   nix build 'github:logos-co/logos-logoscore-cli/tutorial-v3#cli-bundle-dir' --out-link ./logos

   nix build 'github:logos-co/logos-package-manager/tutorial-v3#cli-bundle-dir' --out-link ./lgpm
   ```
