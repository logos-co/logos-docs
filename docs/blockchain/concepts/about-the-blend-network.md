...
In addition to block proposals, nodes can also send Mantle transactions directly through the Blend Network. Using a Proof of Work mechanism known as *[EmPoWering](../../get-started/glossary.md#empowering)*, even a user without any notes benefit from some of the privacy provided by the Blend Network. However, as an edge node, their transaction will not have the full privacy that core nodes enjoy.
