...
The primary example is the [Logos Execution Zone](../../lez/get-started/introduction-to-the-logos-execution-zone.md), the initial host for the messaging and storage applications of the Logos stack, with support for private token transfers and [program](../../get-started/glossary.md#program) execution.
