...
| [ideas](https://github.com/logos-co/ideas) | Community-sourced project ideas to build on top of Logos. Archived (read-only). |
...
| [logos-accounts-module](https://github.com/logos-co/logos-accounts-module) | Early stage [account](glossary.md#account)-management module built on go-wallet-sdk. Archived (read-only). |
...
| [specs](https://github.com/logos-messaging/specs) | Archived. The protocol specifications now live in [logos-lips](https://github.com/logos-co/logos-lips). |
| [logos-delivery-compose](https://github.com/logos-messaging/logos-delivery-compose) | Archived. The Docker Compose files to deploy a node now live in [`logos-delivery/apps/logos_delivery_node/docker`](https://github.com/logos-messaging/logos-delivery/tree/master/apps/logos_delivery_node/docker). |
