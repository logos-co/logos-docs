...
1. Initialise the node with `createNode`, which returns a `LogosResult`. Always check `success` before continuing and surface `getError()` on failure. For a complete list of node configuration keys, see the [Module Interface](https://github.com/logos-co/logos-delivery-module/blob/3258cdb0132e37228aa2519e0c01c0e7429a20dd/README.md#module-interface) section of the README.
