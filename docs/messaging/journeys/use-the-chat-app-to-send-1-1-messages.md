...
- **Key components:**
  - **`logos-chatsdk-ui`** — the Chat App (this journey's app).
...
![Logos Chat App UI screenshot](./use-the-chat-app-to-send-1-1-messages/screenshot.png)
...
- **Expected result:** The exact message text appears as an incoming (left-aligned) bubble in B's chat panel within a few seconds, and a reply sent from B appears as an incoming bubble in A.
