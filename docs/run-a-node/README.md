...
2.  Download the Linux release assets for `logoscore`, `lgpd`, and `lgpm`:
    ...
    For x86\_64 Linux, these are the current download URLs as of 2026-06-25:
...
1.  Create the storage config:
    ...
    * Fields
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>To run storage with <a href="https://docs.logos.co/get-started/glossary#mix">mix</a> support, generate the config from the published mix bootstrap data:</p><pre class="language-sh"><code class="lang-sh">cd /var/lib/logos-node/storage-module
...
2.  Load and start the [storage module](https://docs.logos.co/get-started/glossary#storage-module):
...
2.  Load and start the [delivery module](https://docs.logos.co/get-started/glossary#delivery-module):
